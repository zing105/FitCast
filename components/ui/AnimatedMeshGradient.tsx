...
const VARIANTS = {
  home: {
    ...
    overlay: 'transparent',
    colors: [
      'rgba(0, 100, 255, 0.18)',   // Toss Blue - whisper
      'rgba(50, 130, 255, 0.15)',  // Light Blue - whisper
      'rgba(0, 210, 255, 0.12)',   // Sky Blue - whisper
      'rgba(100, 180, 255, 0.14)', // Soft Blue - whisper
    ],
