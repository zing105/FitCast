...
const VARIANTS = {
  home: {
    ...
    overlay: 'transparent',
    colors: [
      'rgba(0, 100, 255, 0.10)',   // Toss Blue - ultra soft
      'rgba(50, 130, 255, 0.08)',  // Light Blue - ultra soft
      'rgba(0, 210, 255, 0.06)',   // Sky Blue - ultra soft
      'rgba(100, 180, 255, 0.07)', // Soft Blue - ultra soft
    ],
